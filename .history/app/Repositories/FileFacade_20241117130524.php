...
class FileFacade extends Facade
{
    const aspects_map = array(
        ...
        'getFreeFile' =>array('TransactionAspect', 'LoggingAspect','FileLoggingAspect'),
    ...
    public function getFreeFile()
    {
        $id = $this->message['urlParameters']['id']; // استرجاع المعرف من المتغيرات
        $file = $this->fileService->getFreeFile($id); // استدعاء دالة getFreeFile في FileService
        return $file;
    }
